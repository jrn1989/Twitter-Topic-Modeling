...
for root, dirs, files in os.walk("."):
    for file in files:
        if file.endswith(".txt"):
            ...
            # Attention: Some entities are lost, like person names
            ...
            # Sometimes the word "http" goes into the final result somehow, so we validate that it
            # won't appear in the final file
